...
class GainPluginInteract : public OFX::OverlayInteract
{
public:
    GainPluginInteract(OfxInteractHandle p_Handle, OFX::ImageEffect* /*p_Effect*/)
...
class GainOverlayInteractDescriptor : public OFX::DefaultEffectOverlayDescriptor<GainOverlayInteractDescriptor, GainPluginInteract>
{
};
